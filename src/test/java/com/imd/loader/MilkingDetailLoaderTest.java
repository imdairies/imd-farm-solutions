...
class MilkingDetailLoaderTest {
	...
	void testAnimalProcessing() {
		try {
			...
			assertEquals(21,milkRec.getRecordTime().getHourOfDay(), " Record Time should have been 05:30");
			assertEquals(0,milkRec.getRecordTime().getMinuteOfHour(), " Record Time should have been 05:30");
